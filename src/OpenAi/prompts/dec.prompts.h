...
void OpenAiInterface_add_default_prompt(OpenAiInterface *bearOpenAI,const char *role, const char *prompt, bool permanent);

void OpenAiInterface_add_system_prompt(OpenAiInterface *bearOpenAi, const char *prompt, bool permanent);

void OpenAiInterface_add_user_prompt(OpenAiInterface *bearOpenAi, const char *prompt, bool permanent);
